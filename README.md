...
Il vise a fournir aux étudiants les bases pour faire de l'analyse de données avec Python, en utilisant **Jupyter Notebook** comme environnement de travail. Dans le cas où il est impossible d'installer Anaconda, il est possible d'utiliser [Google Colab](https://colab.research.google.com/notebooks/basic_features_overview.ipynb). 
